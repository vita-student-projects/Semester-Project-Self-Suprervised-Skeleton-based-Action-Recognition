...
from pretrain_engine_v1 import train_one_epoch
...
def get_args_parser():
    ...
    parser.add_argument('--config', default='./config/ntu60_xsub_pretrain_v1.yaml', help='path to the configuration file')
    # parser.add_argument('--config', default='./config/ntu60_xsub_pretrain_v2.yaml', help='path to the configuration file')
