...
def get_args_parser():
    parser = argparse.ArgumentParser('SpatialFormer Fine-tuning', add_help=False)
    parser.add_argument('--config', default='./config/ntu60_xsub_joint_linear_debug_v2.yaml', help='path to the configuration file')
