...
def get_args_parser():
    parser = argparse.ArgumentParser('SpatialFormer Supervised', add_help=False)
    parser.add_argument('--config', default='./config/ntu60_xsub_joint_sv_debug.yaml', help='path to the configuration file')
    ...
    parser.add_argument('--output_dir', default='./output_dir_sv',
...
def main(rank, world_size, args):
    ...
    if args.finetune and not args.eval:
        ...
        # model.module.studentspatial.load_state_dict(checkpoint)
