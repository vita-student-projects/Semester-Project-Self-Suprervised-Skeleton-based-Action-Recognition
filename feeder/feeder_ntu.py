...
class Feeder(Dataset):
    ...
    def __getitem__(self, index):
        ...
        return data_numpy.permute(3, 1, 2, 0).float().clone().detach(), label, index
...
if __name__ == '__main__':
    ...
    db = NTUDataset(data_path='/home/ruihang/Skeleton/Code/SkeletonJEPA/data/NTU60_XSub.npz', split='train', window_size=300)
